...
const employeePrompt = [
    ...
    },
    {
        ...
        choices: ['Jon Doe', 'Mike Chan', 'Ashley Rodriguez', 'Kevin Tupik', 'Malia Brown', 'Sarah Lourd', 'Tom Allen', 'Curtis Jones', 'Tyson Mack', 'Rebecca Flounder'],
        when: ({ confirmManager }) => {
            if (confirmManager) {
                return true;
            } else {
...
const getId = (employeeX) => {
    ...
    if (employeeX === 'Jon Doe') {employeeId = 1}
    ...
    if (employeeX === 'Curtis Jones') {employeeId = 8}
...
const employeeUpdatePrompt = [
    {
        ...
        choices: ['Jon Doe', 'Mike Chan', 'Ashley Rodriguez', 'Kevin Tupik', 'Malia Brown', 'Sarah Lourd', 'Tom Allen', 'Curtis Allen', 'Tyson Mack', 'Rebecca Flounder']
    },
    {
        type: 'list',
        name: 'newRole',
